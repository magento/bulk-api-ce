...
class Router
{
    ...
    /**
     * @var \Magento\WebapiAsync\Model\Async\Config
     */
     ...
     *
     * @param \Magento\WebapiAsync\Model\Async\Config $apiConfig
     */
    public function __construct(\Magento\WebapiAsync\Model\Async\Config $apiConfig)
    {
     ...
     * @return \Magento\BulkApi\Controller\Async\Router\Route
     * @throws \Magento\Framework\Webapi\Exception
     */
    public function match(Request $request)
    {
        /** @var \Magento\WebapiAsync\Controller\Rest\Async\Router\Route[] $routes */
