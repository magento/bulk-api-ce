 ...
 */
namespace Magento\WebapiAsync\Model\Async;
...
class Config
{
     ...
     *      'secure' => true
     *  );</pre>
     * @return \Magento\WebapiAsync\Controller\Rest\Async\Router\Route
     */
    protected function _createRoute($routeData)
    {
        ...
        $route = $this->_routeFactory->createRoute(
            \Magento\WebapiAsync\Controller\Rest\Async\Router\Route::class,
    ...
    public function getRestRoutes(\Magento\Framework\Webapi\Rest\Request $request)
    {
        ...
        $routes = [];
        $pathInfo=str_replace('/async/V1/','/V1/',$request->getPathInfo());
